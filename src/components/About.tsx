  ...
  return <section id="o-nas" className="section-padding bg-secondary">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={imageRef} className={`relative transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            <div className="aspect-[4/5] bg-muted rounded-lg overflow-hidden group cursor-pointer">
              <img src={nataliaPhoto} alt="Adwokat Natalia Kijaczko-Gołaś" className="w-full h-full object-cover object-top transition-all duration-500 ease-out 
