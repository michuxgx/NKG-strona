...
const Services = () => {
  return <section id="uslugi" className="section-padding bg-background">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => <div key={service.title} className="card-elevated rounded-lg p-8 group cursor-pointer" style={{
